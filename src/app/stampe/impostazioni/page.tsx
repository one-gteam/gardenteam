  ...
  return (
    <div>
      ...
      <div className="container">
        ...
        <div className="section-head"><h2>Campi personalizzati di {scope.label} ({myFields.length})</h2></div>
        <div className="card" style={{ marginBottom: 24 }}>
        ...
        <div className="section-head"><h2>Collegamento SharePoint</h2></div>
        <div className="card" style={{ maxWidth: 720, marginBottom: 28 }}>
          ...
          <form action={saveStampeSettings}>
            <label className="field">
              Link cartella immagini SharePoint
